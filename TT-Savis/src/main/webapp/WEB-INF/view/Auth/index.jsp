            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="/loginView" class="nav-item nav-link active">Shopping Cart</a>
                        <a href="#" class="nav-item nav-link active">Checkout</a>
                        <a href="/loginView" class="nav-item nav-link active">Hoa Don</a>
            ...
            <c:forEach items="${page.getContent()}" var="sp">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/ASM/quan-ly-tu-lanh/view-update1/${sp.id}" class="btn btn-success">Detail</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
                ...
                <div>
                    <ul class="pagination">
                        ...
                        <li class="page-item"><c:if test="${page.getNumber() + 1 lt page.getTotalPages()}">
                            <a class="page-link" href="?page=${page.getNumber() + 2}&tenTaiNghe=${param.ten}">
                                Next
                            </a>
                        </c:if>
                        </li>
